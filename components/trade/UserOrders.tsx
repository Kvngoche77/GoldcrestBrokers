    ...
    <div className="flex flex-col h-full bg-[#0b0e11] select-none">
      ...
      <div className="flex-1 overflow-hidden">
        <ScrollArea className="h-full">
          {activeTab === 'Funds' ? (
            <div className="p-4 text-[#848e9c] text-sm italic">Connect your wallet to view funds.</div>
          ) : (
            <Table>
              ...
              <TableBody>
                <TableRow className="border-b border-[#1e2329]/50 hover:bg-[#1e2329]/30">
                  <TableCell className="text-[11px] py-1.5 text-[#848e9c] font-mono whitespace-nowrap">2026-05-06 08:00:12</TableCell>
                ...
                <TableRow className="border-b border-[#1e2329]/50 hover:bg-[#1e2329]/30">
                  <TableCell className="text-[11px] py-1.5 text-[#848e9c] font-mono whitespace-nowrap">2026-05-06 07:45:30</TableCell>
